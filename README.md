...
4. Copy the `aws-login` script to somewhere you can run it. Usually somewhere on your `%PATH%` or make a symlink to it from somewhere like `/usr/local/bin`. Make sure to make it executable, i.e. `chmod ug+x aws-login`.

That's it. You should be good to go.

## Usage

You can run `aws-login` passing it the name of the profile you want credentials for.
